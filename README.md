...
# Reset to a Commit
# Soft Reset (কোড হারাবে না): এটি কমিটটি ডিলিট করে দিবে কিন্তু আপনার লেখা কোডগুলো staged অবস্থায় রেখে দিবে।
git reset --soft HEAD~1

# Hard Reset (কোড হারাবে): এটি আপনার শেষ কমিট এবং ওই কমিটে করা সব কোড পুরোপুরি ডিলিট করে দিবে। সাবধানতার সাথে ব্যবহার করবেন!
git reset --hard HEAD~1

# (বি:দ্র: HEAD~1 মানে ১টি কমিট। আপনি যদি শেষ ৩টি কমিট মুছতে চান তবে HEAD~3 লিখবেন।)
```
